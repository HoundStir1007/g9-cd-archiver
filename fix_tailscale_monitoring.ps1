...
function Start-Diagnosis {
    ...
    if ($passCount -eq $totalCount) {
        ...
        Write-Host "⚠️ Issues detected. Review the failures above." -ForegroundColor Yellow
    }
...
Write-Host "`n🎯 This script diagnoses the monitoring system issues" -ForegroundColor Cyan

Write-Host "`n===========================================" -ForegroundColor Cyan
Write-Host "🔧 Tailscale Monitoring Diagnosis Complete!" -ForegroundColor Cyan