...
# 🎬 Thunderbolt Movie Migration to Jellyfin
...
LOG_FILE="thunderbolt_movie_migration_$(date +%Y%m%d_%H%M%S).log"
...
# Get top 20 largest movies and move them
grep "mkv\|m4v\|mp4" thunderbolt_full_analysis.txt | sort -k2 -nr | head -20 | while read line; do
    # Parse the line: format is "ext size path"
